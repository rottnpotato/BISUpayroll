...
DROP FUNCTION IF EXISTS calculate_late_deductions(DECIMAL, DECIMAL, DECIMAL, DECIMAL, TEXT);
DROP FUNCTION IF EXISTS calculate_late_deductions(DECIMAL, DECIMAL, DECIMAL, TEXT);
DROP FUNCTION IF EXISTS calculate_late_deductions(INTEGER, NUMERIC, NUMERIC, TEXT);

-- Create the function with proper default parameters
