-- =====================================================
-- UPDATE: Include approved overtime requests in payroll calculation
-- =====================================================
...
COMMENT ON FUNCTION calculate_payroll_for_period IS 'Calculates complete payroll including approved overtime requests and overload records. Regular pay is based on actual hours worked. Overtime and overload require explicit approval.';
