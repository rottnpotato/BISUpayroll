...
export function AnimatedSidebar({ items, logo, userInfo, onLogout, onCollapsedChange }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex flex-col bg-gradient-to-b from-bisu-purple-deep to-bisu-purple-medium border-r border-bisu-yellow-DEFAULT/20 shadow-xl transition-all duration-300 ease-in-out",
      ...
      >
        ...
        <div className="flex items-center justify-between h-20 px-4 border-b border-bisu-yellow-DEFAULT/20">
          ...
          <Button
            ...
            className={cn(
              "text-bisu-yellow-DEFAULT hover:bg-bisu-purple-medium rounded-full transition-colors",
              "ml-auto"
            )}
          >
            {isMobile ? (
                        ...
                        <Link
                          ...
                          className={cn(
                            ...
                            isActive
                              ...
                              : "text-bisu-yellow-light hover:bg-bisu-purple-medium/50 hover:text-bisu-yellow-DEFAULT",
                            isActive && !isCollapsed && "border-l-4 border-bisu-yellow-DEFAULT pl-2" 
                          )}
                        >
                          <span className={cn(
